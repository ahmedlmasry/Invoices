                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ number_format(Invoice::sum('Total'), 2) }}                                            </h4>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">{{ Invoice::where('Value_Status', 2)->count() }}
                            </div>
                            <span class="float-right my-auto mr-auto">
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
                                                 @php
                                                     $count_all= Invoice::count();
                                                     $count_invoices2 = Invoice::where('Value_Status', 1)->count();
